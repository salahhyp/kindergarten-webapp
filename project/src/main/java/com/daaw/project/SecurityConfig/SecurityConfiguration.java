...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers("/api/evaluations/**").permitAll()
                .requestMatchers("/api/evaluations/child/post").permitAll()
                .requestMatchers("/api/evaluations/child/{childId}").permitAll()
                .requestMatchers("/api/evaluations/educator/{educatorId}").permitAll()
                ...
                .requestMatchers("/api/preinscrit/**").permitAll()
